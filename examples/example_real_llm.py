...
def main():
    ...
    if not API_KEY:
        print(
            "Please set your OpenRouter API key in the OPENAI_API_KEY environment variable."
        )
        return
    ...
    config = SanConfig(
        ...
        custom_dict={"Sarah Johnson": "PERSON", "General Hospital": "HOSPITAL"},
        regex_patterns={
    ...
    try:
        ...
        print(
            f"✓ Processed {len(deanonymized_response)} characters through OpenRouter LLM"
        )
        ...
        if restored_count == 0:
            ...
            print(
                "  LLM may have used different phrasing or avoided the anonymized tokens"
            )
