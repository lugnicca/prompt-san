...
def example_performance_comparison():
    ...
    """ * 10  # Repeat 10x for more meaningful timing
    ...
    print(f"   Most entities: {most_entities} ({results[most_entities]['entities']} entities)")
