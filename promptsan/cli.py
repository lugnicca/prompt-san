...
def main():
    ...
    deanon_parser.add_argument("--output-file", type=str, help="Output file for deanonymized text")
    deanon_parser.add_argument("--mapping-file", type=str, required=True, 
                             help="Mapping JSON file")

    # Stream deanonymize command
    stream_parser = subparsers.add_parser("stream-deanonymize", 
                                        help="Deanonymize streaming text")
    stream_parser.add_argument("--input-file", type=str, help="Input file path")
    stream_parser.add_argument("--output-file", type=str, help="Output file for deanonymized text")
    stream_parser.add_argument("--mapping-file", type=str, required=True, 
                             help="Mapping JSON file")
    stream_parser.add_argument("--chunk-size", type=int, default=100, 
...
def _handle_anonymize(args, base_config: SanConfig):
...
def _handle_stream_deanonymize(args):
